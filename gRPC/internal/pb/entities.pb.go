...
const file_proto_entities_proto_rawDesc = "" +
	"\n" +
	"\x14proto/entities.proto\x12\x02pb\x1a\x1bgoogle/protobuf/empty.proto\"P\n" +
	"\bCategory\x12\x0e\n" +
	...
	"\x14CreateCategoryStream\x12\x19.pb.CreateCategoryRequest\x1a\x18.pb.CategoryListResponse\"\x00(\x01\x12Z\n" +
	"!CreateCategoryStreamBidirectional\x12\x19.pb.CreateCategoryRequest\x1a\x14.pb.CategoryResponse\"\x00(\x010\x01\x12B\n" +
...
var file_proto_entities_proto_goTypes = []any{
	...
	(*CategoryListResponse)(nil),  // 2: pb.CategoryListResponse
...
var file_proto_entities_proto_depIdxs = []int32{
	...
	5, // 5: pb.CategoryService.ListCategory:input_type -> google.protobuf.Empty
	4, // 6: pb.CategoryService.GetCategory:input_type -> pb.GetCategoryRequest
	1, // 7: pb.CategoryService.CreateCategory:output_type -> pb.CategoryResponse
	2, // 8: pb.CategoryService.CreateCategoryStream:output_type -> pb.CategoryListResponse
	1, // 9: pb.CategoryService.CreateCategoryStreamBidirectional:output_type -> pb.CategoryResponse
	2, // 10: pb.CategoryService.ListCategory:output_type -> pb.CategoryListResponse
	1, // 11: pb.CategoryService.GetCategory:output_type -> pb.CategoryResponse
